...
public class PracticeDbContext :
    AbpDbContext<PracticeDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(PracticeConsts.DbTablePrefix + "YourEntities", PracticeConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
        builder.Entity<Customer>(b =>
        {
            b.ToTable(PracticeConsts.DbTablePrefix + "Customers",
                PracticeConsts.DbSchema);
